...
//				FileItemFactory factory = new DiskFileItemFactory();
				...
				factory.setRepository(new File("D:\\eclipse-workspace\\Temp"));//设置临时文件的目录
				//控制上传单个文件的大小  1024KB ServletFileUpload
				upload.setSizeMax(1048576);//字节B
				Thread.sleep(3000);
				...
				while (iter.hasNext()) {
					...
					if (item.isFormField()) {
						...
						if(!(ext.equals("png") || ext.equals("gif") || ext.equals("jpg"))) {
							System.out.println("文件类型有误！格式只能是png、gif、jpg！");
							return ;//终止
						}
						// 获取文件内容 并上传
						...
						String path = "D:\\eclipse-workspace\\Upload";
			...
			System.out.println("上传文件大小超过限制！最大1MB！");
		}
